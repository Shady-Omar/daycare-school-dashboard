      ...
      <div className="hidden lg:flex items-start gap-2.5 self-stretch">
        <Link
          ...
          className={`flex p-5 items-center gap-2.5 ${
            ...
            currentPath === "/my-center/room/details"
              ? "bg-[#FFF]"
              : ""
          }`}
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-[11px]">
              {currentPath === "/my-center/room/details/children" ||
              currentPath === "/my-center/room/details" ? (
                <h5 className="h5-semi text-[#383838]">Children</h5>
              ) : currentPath === "/my-center/room/details/family" ? (
                <h5 className="h5-semi text-[#383838]">Family</h5>
              ) : currentPath === "/my-center/room/details/activities" ? (
                <h5 className="h5-semi text-[#383838]">Activities</h5>
              ) : currentPath === "/my-center/room/details/manage" ? (
                <h5 className="h5-semi text-[#383838]">Managing Staff</h5>
              ) : (
                ""
              )}
            </div>
