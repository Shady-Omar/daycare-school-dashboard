...
function MessagesContent() {
  return (
    <div className="flex p-[30px] flex-col justify-center items-start gap-[30px] self-stretch bg-white rounded-[10px] lg:rounded-[0px_10px_10px_10px]">
      <div className="flex flex-col lg:flex-row items-start gap-[30px] self-stretch rounded-[10px]">
        {/* Chat Menu */}
        <div className="flex lg:w-[290px] lg:min-h-[1000px] flex-col items-start gap-2.5 self-stretch rounded-[10px] bg-white">
          <NewMessageModal />
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start gap-[5px]">
                    ...
                    <p className="p-reg text-[#A4A4A4] text-left !text-[15px]">
                      Lorem ipsum dolor...
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start gap-[5px]">
                    ...
                    <p className="p-reg text-[#FFFFFFCC] text-left !text-[15px]">
                      Lorem ipsum dolor...
                    </p>
                  </div>
                </div>
        ...
        {/* Chat details */}
        <div
          className="flex flex-col lg:h-[700px] lg:justify-between items-start gap-10 lg:gap-0 self-stretch bg-[#F9F9F9]"
        ...
        >
          ...
          {/* Chat Box */}
          <div className="flex flex-col p-[0px_10px_30px_10px] lg:p-[0px_30px_30px_30px] justify-end items-start gap-10 self-stretch">
            {/* Messages */}
            <div className="flex px-2.5 lg:px-[30px] flex-col items-start gap-[50px] self-stretch">
              <div className="flex flex-col items-start gap-5 self-stretch">
                ...
                <div className="flex flex-col items-end gap-2.5 self-stretch">
                  ...
                  >
                    <p className="p-reg text-white text-right">Hello Sur!</p>
                  </div>
                  <div className="flex py-[17px] px-[21px] items-start gap-2.5 bg-[#5ECFFF] rounded-xl">
                    <p className="p-reg text-white text-right">
            ...
            <div className="flex flex-col items-start self-stretch rounded-[10px] bg-white">
              ...
              {/* Controls */}
              <div
                className="flex flex-col lg:flex-row py-5 px-[30px] gap-[30px] lg:gap-0 lg:justify-between items-start lg:items-center self-stretch bg-white"
                style={{
              ...
              >
                ...
                <button className="cyan-btn self-stretch">Send Message</button>
              </div>
            </div>
          </div>
        </div>
