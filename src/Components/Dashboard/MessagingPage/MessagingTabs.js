      ...
      <div className="hidden lg:flex items-start gap-2.5 self-stretch">
        <Link
          ...
          className={`flex p-5 items-center gap-2.5 ${
            currentPath === "/chat/messages" || currentPath === "/chat"
              ? "bg-[#FFF]"
              : ""
          }`}
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-[11px]">
              {currentPath === "/chat/messages" || currentPath === "chat" ? (
                <h5 className="h5-semi text-[#383838]">Messages</h5>
              ) : currentPath === "/chat/management" ? (
                <h5 className="h5-semi text-[#383838]">Visit Management</h5>
              ) : currentPath === "/chat/announcements" ? (
                <h5 className="h5-semi text-[#383838]">Announcements</h5>
              ) : (
                ""
              )}
            </div>
