            ...
            >
              ...
              <Dialog.Panel className="flex w-[340px] lg:w-[784px] p-[30px] flex-col justify-center items-center gap-[30px] rounded-[10px] bg-[#FFF]">
                ...
                <div className="flex flex-col justify-center items-center gap-5 self-stretch">
                  <div className="flex flex-col justify-center items-center gap-5 lg:gap-2.5 self-stretch">
                    <div
                      className="flex flex-col lg:flex-row lg:justify-between items-start self-stretch gap-2.5 lg:gap-0"
                      style={{ borderBottom: "1px solid #EBEBEB" }}
                    >
                      <div className="flex lg:w-[193px] lg:py-5 items-start gap-[15px] self-stretch">
                        <h5 className="h5-bold text-[#383838]">Date</h5>
                      </div>
                      <div className="flex lg:w-[483px] pb-5 lg:p-5 items-start gap-2.5 self-stretch">
