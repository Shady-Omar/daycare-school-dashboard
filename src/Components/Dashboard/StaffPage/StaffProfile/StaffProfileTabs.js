          ...
          >
            ...
            <div className="flex items-center gap-[11px]">
              {currentPath === "/staff/profile" ? (
                ...
                <h5 className="h5-semi text-[#383838]">Permissions</h5>
              ) : currentPath === "/staff/profile/activity-log" ? (
                <h5 className="h5-semi text-[#383838]">Activity Log</h5>
              ) : currentPath === "/staff/profile/requests-log" ? (
                <h5 className="h5-semi text-[#383838]">Requests Log</h5>
              ) : currentPath === "/staff/profile/salary-log" ? (
                <h5 className="h5-semi text-[#383838]">Salary Log</h5>
              ) : currentPath === "/staff/profile/attendance-log" ? (
                <h5 className="h5-semi text-[#383838]">Attendance Log</h5>
              ) : (
                ""
              )}
            </div>
